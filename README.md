...
My objective is integrating a genetic algorithm on top of the parallelized model training. An early version of this where worse 25% of the population is killed in each epoch is already implemented.
