...
*** Check ars_dataparallel.py for a working unique implementation of Augmented Random Search, which auto-scales accross several GPU(s), on a toy linear regression problem. The rest of the codes within the repository are currently experimental ***
