...
*** Check ars_dataparallel.py for a working unique implementation of Augmented Random Search (ARS), which auto-scales accross several GPU(s), on a toy linear regression problem. The rest of the codes within the repository, including some evolutionary attempts over ARS, are currently experimental ***
